...
class Game(arcade.Window):
    ...
    def initgame(self):
        ...
        self.events = [
            ...
            "Ты понимаешь, что третий раз выходишь на одно и то же место.",
            ...
            "Ты видишь руины башни, здесь вполне можно остановиться на ночлег.",
            ...
            "Ты вышла из леса и увидела перед собой тропу ведущую в огромную крепость",
    ...
    def handle_continue(self):
        ...
        self.yes_button["visible"] = self.current_event in [self.events[6], self.events[19]]
